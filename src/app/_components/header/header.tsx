...
import prato from '@/assets/images/dish-2.png'
...
export function Header() {
  return (
    <header className="relative flex flex-col-reverse lg:flex-row items-center justify-between gap-10 mb-16 lg:my-28">
      ...
      <Details1 clasName="absolute hidden md:block md:right-[-20px] lg:right-[-120px] top-[-120px] opacity-15" />
      <Details3 clasName="absolute hidden md:block md:right-[-50px] lg:right-[-150px] top-[330px] opacity-15" />
      <Details2 clasName="absolute hidden md:block md:right-[350px] lg:right-[220px] top-[-80px] opacity-15" />
      <Image
        src={prato}
      ...
      />
      <div className="absolute hidden sm:block top-[-785px] left-[-700px] w-[960px] h-[960px] rounded-full border border-foreground opacity-15" />
      <div className="absolute hidden sm:block top-[-860px] left-[-630px] w-[960px] h-[960px] rounded-full border border-foreground opacity-15" />
      <div className="absolute hidden sm:block top-[-760px] left-[-600px] w-[960px] h-[960px] rounded-full border border-foreground opacity-15" />
      {/* End Details */}
      ...
      <div className="flex flex-col gap-10 md:gap-16 lg:max-w-[400px] xl:max-w-[700px]">
        ...
        <div className="space-y-10 md:space-y-12">
          <span className="text-muted-foreground block max-w-[400px]">
